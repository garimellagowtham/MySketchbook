#ifndef ros_rustler_comm_position_h
#define ros_rustler_comm_position_h
  ...
  class position : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer)
    {
      ...
      *(outbuffer + offset++) = (exp_z>>4) & 0x7F;
      ...
      long * val_yaw = (long *) &(this->yaw);
      long exp_yaw = (((*val_yaw)>>23)&255);
      if(exp_yaw != 0)
        exp_yaw += 1023-127;
      long sig_yaw = *val_yaw;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      *val_z |= ((unsigned long)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      unsigned long * val_yaw = (unsigned long*) &(this->yaw);
      offset += 3;
      *val_yaw = ((unsigned long)(*(inbuffer + offset++))>>5 & 0x07);
      *val_yaw |= ((unsigned long)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_yaw |= ((unsigned long)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_yaw |= ((unsigned long)(*(inbuffer + offset)) & 0x0f)<<19;
      unsigned long exp_yaw = ((unsigned long)(*(inbuffer + offset++))&0xf0)>>4;
      exp_yaw |= ((unsigned long)(*(inbuffer + offset)) & 0x7f)<<4;
      if(exp_yaw !=0)
    ...
    const char * getType(){ return "rustler_comm/position"; };
