...
typedef struct __mavlink_hil_state_t
{
 ...
 float rollspeed; ///< Roll angular speed (rad/s) in body frame
 float pitchspeed; ///< Pitch angular speed (rad/s) in body frame
 float yawspeed; ///< Yaw angular speed (rad/s) in body frame
 int32_t lat; ///< Latitude, expressed as * 1E7
 int32_t lon; ///< Longitude, expressed as * 1E7
 int32_t alt; ///< Altitude in meters, expressed as * 1000 (millimeters)
 int16_t vx; ///< Ground X Speed (Latitude), expressed as m/s * 100
 int16_t vy; ///< Ground Y Speed (Longitude), expressed as m/s * 100
 int16_t vz; ///< Ground Z Speed (Altitude), expressed as m/s * 100 (+ve down)
 int16_t xacc; ///< X acceleration (mg) in body frame (+ve forward)
 int16_t yacc; ///< Y acceleration (mg) in body frame (+ve right)
 int16_t zacc; ///< Z acceleration (mg) in body frame (+ve down)
} mavlink_hil_state_t;
 ...
 * @param rollspeed Roll angular speed (rad/s) in body frame
 * @param pitchspeed Pitch angular speed (rad/s) in body frame
 * @param yawspeed Yaw angular speed (rad/s) in body frame
 * @param lat Latitude, expressed as * 1E7
 * @param lon Longitude, expressed as * 1E7
 * @param alt Altitude in meters, expressed as * 1000 (millimeters)
 * @param vx Ground X Speed (Latitude), expressed as m/s * 100
 * @param vy Ground Y Speed (Longitude), expressed as m/s * 100
 * @param vz Ground Z Speed (Altitude), expressed as m/s * 100 (+ve down)
 * @param xacc X acceleration (mg) in body frame (+ve forward)
 * @param yacc Y acceleration (mg) in body frame (+ve right)
 * @param zacc Z acceleration (mg) in body frame (+ve down)
 ...
 *
 * @return Roll angular speed (rad/s) in body frame
 */
 ...
 *
 * @return Pitch angular speed (rad/s) in body frame
 */
 ...
 *
 * @return Yaw angular speed (rad/s) in body frame
 */
 ...
 *
 * @return Ground Z Speed (Altitude), expressed as m/s * 100 (+ve down)
 */
 ...
 *
 * @return X acceleration (mg) in body frame (+ve forward)
 */
 ...
 *
 * @return Y acceleration (mg) in body frame (+ve right)
 */
 ...
 *
 * @return Z acceleration (mg) in body frame (+ve down)
 */
