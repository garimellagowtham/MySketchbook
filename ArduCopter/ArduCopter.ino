...
void loop()
{
    ...
    if (num_samples >= 1) {//Changing the main fast loop freq to 200Hz :)
   ...
   /* else {
        ...
        usleep(1000);
#endif
        if (timer - fast_loopTimer < 4000) {//changed from 9000 to 4000 as only one sample is being collected.
